...
class ArchitectureRenderer:
    ...
    CSS = """
    .arch-container { display: grid; gap: 20px; padding: 20px; font-family: sans-serif; }
    .component { border: 2px solid #333; padding: 15px; border-radius: 8px; background: #f4f4f4; }
    .type-service { border-color: #2ecc71; }
    .type-database { border-color: #e74c3c; background: #fdf2f2; }
